...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = Field(
        ..., description="URL de conexão com PostgreSQL"  # obrigatório
    )
    ...
    # ============================================================
    REDIS_URL: str = Field(
        default="redis://localhost:6379/0", description="URL completa do Redis"
    )
    ...
    EVOLUTION_API_KEY: str = Field(
        ..., min_length=10, description="API Key da Evolution"
    )

    # ============================================================
    # 🔹 OpenAI
    # ============================================================
    OPENAI_API_KEY: str = Field(..., min_length=20, description="API Key da OpenAI")
    MODEL_DEFAULT: str = Field(
        default="gpt-4o-mini", description="Modelo padrão para conversas"
    )
    MODEL_ANALYZE_IMAGE: str = Field(
        default="gpt-4o", description="Modelo para análise de imagens"
    )
    ...
    WEBHOOK_SECRET: str | None = Field(
        default=None, description="Secret para validar assinaturas de webhook"
    )
